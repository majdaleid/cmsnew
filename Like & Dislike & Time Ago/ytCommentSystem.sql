...
(21, 2, 'aaaaaaaaa', '2019-07-26 09:11:38'),
(22, 2, 'ffffffffffff', '2019-07-26 09:14:20'),
(23, 2, 'bbbbbbbbbb', '2019-07-26 09:15:16');
...
INSERT INTO `reactions` (`id`, `userID`, `commentID`, `type`, `isReply`) VALUES
(10, 2, 23, 'up', 'no'),
(11, 2, 20, 'down', 'yes'),
(12, 2, 22, 'down', 'no');
...
(20, 23, 'cccccccc', '2019-07-26 09:15:24', 2);
...
--
ALTER TABLE `reactions`
  ADD CONSTRAINT `reactions_ibfk_2` FOREIGN KEY (`userID`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
